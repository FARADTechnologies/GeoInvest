...
const D: Dict = {
  ...
  "Mərt. (cəmi)": { tr: "Kat (toplam)", en: "Floors (total)" },
  "Sütunlar": { tr: "Sütunlar", en: "Columns" },
  "Sütunları göstər": { tr: "Sütunları göster", en: "Show columns" },
  "Sıfırla": { tr: "Sıfırla", en: "Reset" },
  "Əsas məlumat": { tr: "Temel bilgi", en: "Basic info" },
  "Qiymətləndirmə": { tr: "Fiyatlandırma", en: "Valuation" },
  ...
  "Kirayə ilə geri ödəmə": { tr: "Kira ile geri ödeme", en: "Payback via rent" },
  "500m radiusda orta qiymət": { tr: "500m yarıçapta ortalama fiyat", en: "Average price within 500 m" },
  "Mənzilin qiymət artımı": { tr: "Dairenin fiyat artışı", en: "This property's price growth" },
  "Bakı üzrə qiymət artımı": { tr: "Bakü geneli fiyat artışı", en: "Price growth across Baku" },
  "Rayon üzrə qiymət artımı": { tr: "Rayon geneli fiyat artışı", en: "Price growth in the rayon" },
